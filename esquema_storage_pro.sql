...
CREATE POLICY "assets_delete_admin" ON "storage"."objects" FOR DELETE TO "authenticated" USING ((("bucket_id" = 'school-assets'::"text") AND ("public"."auth_role"() = 'admin'::"text")));



CREATE POLICY "assets_insert_admin" ON "storage"."objects" FOR INSERT TO "authenticated" WITH CHECK ((("bucket_id" = 'school-assets'::"text") AND ("public"."auth_role"() = 'admin'::"text")));



CREATE POLICY "assets_select_all" ON "storage"."objects" FOR SELECT USING (("bucket_id" = 'school-assets'::"text"));



CREATE POLICY "assets_update_admin" ON "storage"."objects" FOR UPDATE TO "authenticated" USING ((("bucket_id" = 'school-assets'::"text") AND ("public"."auth_role"() = 'admin'::"text")));
...
CREATE POLICY "docs_delete_admin" ON "storage"."objects" FOR DELETE TO "authenticated" USING ((("bucket_id" = 'school-documents'::"text") AND ("public"."auth_role"() = 'admin'::"text")));



CREATE POLICY "docs_insert_admin" ON "storage"."objects" FOR INSERT TO "authenticated" WITH CHECK ((("bucket_id" = 'school-documents'::"text") AND ("public"."auth_role"() = 'admin'::"text")));



CREATE POLICY "docs_select_all" ON "storage"."objects" FOR SELECT USING (("bucket_id" = 'school-documents'::"text"));



CREATE POLICY "docs_update_admin" ON "storage"."objects" FOR UPDATE TO "authenticated" USING ((("bucket_id" = 'school-documents'::"text") AND ("public"."auth_role"() = 'admin'::"text")));
...
CREATE POLICY "photos_delete_admin" ON "storage"."objects" FOR DELETE TO "authenticated" USING ((("bucket_id" = 'daily-photos'::"text") AND ("public"."auth_role"() = 'admin'::"text")));



CREATE POLICY "photos_insert_staff" ON "storage"."objects" FOR INSERT TO "authenticated" WITH CHECK ((("bucket_id" = 'daily-photos'::"text") AND ("public"."auth_role"() = ANY (ARRAY['admin'::"text", 'teacher'::"text"]))));



CREATE POLICY "photos_select_authenticated" ON "storage"."objects" FOR SELECT TO "authenticated" USING (("bucket_id" = 'daily-photos'::"text"));

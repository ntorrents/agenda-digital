  ...
  return (
    <div className="flex flex-col sm:flex-row gap-3">
      <div className="flex flex-col gap-1.5">
        <label className="text-[10px] font-bold text-stone-500 uppercase tracking-wider pl-1">Aula</label>
        <select
      ...
      <div className="flex flex-col gap-1.5">
        <label className="text-[10px] font-bold text-stone-500 uppercase tracking-wider pl-1">Data / Fecha</label>
        <input
          type="date"
          value={currentDate}
          onChange={handleDateChange}
          className="bg-white border border-stone-200 rounded-xl px-3 py-2 text-sm font-semibold text-stone-800 focus:outline-none focus:ring-2 focus:ring-teal-500/20 cursor-pointer"
        />
      </div>
    </div>
  )

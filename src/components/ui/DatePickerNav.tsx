...
type DatePickerNavProps = {
  ...
  replace?: boolean
  className?: string
  /** Abre el calendario debajo del header completo (evita tapar logo/nombre en móvil) */
  popoverAnchor?: 'trigger' | 'header'
}
...
export function DatePickerNav({
  ...
  useEffect(() => {
    ...
    const updatePosition = () => {
      ...
      if (popoverAnchor === 'header' && headerEl) {
    ...
    open && popoverPos && typeof document !== 'undefined'
      ? createPortal(
          <div
            ...
            className="fixed z-[200] -translate-x-1/2 animate-in fade-in zoom-in-95 duration-200"

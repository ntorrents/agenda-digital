...
export default function ComunicacionPage() {
  ...
  return (
    <main className="p-4 sm:p-6 lg:p-8 space-y-6 max-w-5xl mx-auto pb-16">
      ...
      <div className="bg-white border border-stone-200/80 rounded-3xl shadow-sm relative overflow-hidden">
        ...
        <div className="relative z-10 w-full max-w-3xl mx-auto px-5 sm:px-8 py-8 sm:py-10">
          <div className="text-center mb-8">
            <h2 className="text-xl sm:text-2xl font-black text-stone-800 mb-2">{t('centerTitle')}</h2>
            <p className="text-stone-500 font-medium leading-relaxed max-w-lg mx-auto text-sm sm:text-base">
              {t('centerDesc')}
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 w-full">
            <Link
              ...
              className="group bg-white p-5 sm:p-6 rounded-2xl border border-stone-200 shadow-sm hover:shadow-md hover:border-amber-200 transition-all text-left relative overflow-hidden"
            >
            ...
            <Link
              ...
              className="group bg-white p-5 sm:p-6 rounded-2xl border border-stone-200 shadow-sm hover:shadow-md hover:border-cyan-200 transition-all text-left relative overflow-hidden"
            >

    ...
    <div className="flex flex-col gap-3 w-full min-w-0 md:flex-row md:items-end md:gap-3 md:w-auto">
      <div className="flex flex-col gap-1.5 w-full min-w-0 md:w-44 lg:w-52 shrink-0">
        ...
        <select
          ...
          className="w-full bg-white border border-stone-200 rounded-xl px-3 py-2.5 text-sm font-semibold text-stone-800 focus:outline-none focus:ring-2 focus:ring-teal-500/20 cursor-pointer"
        >
          {classrooms.map((c) => (

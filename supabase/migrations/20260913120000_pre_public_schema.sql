...
--
-- Name: classroom_level; Type: TYPE; Schema: public; Owner: postgres
--
...
--
-- Name: diaper_type; Type: TYPE; Schema: public; Owner: postgres
--
...
--
-- Name: event_audience; Type: TYPE; Schema: public; Owner: postgres
--
...
--
-- Name: guardian_relation; Type: TYPE; Schema: public; Owner: postgres
--
...
--
-- Name: meal_amount; Type: TYPE; Schema: public; Owner: postgres
--
...
--
-- Name: staff_attendance_status; Type: TYPE; Schema: public; Owner: postgres
--
...
--
-- Name: student_gender; Type: TYPE; Schema: public; Owner: postgres
--
...
--
-- Name: admin_set_user_password(uuid, text); Type: FUNCTION; Schema: public; Owner: postgres
--
...
--
-- Name: create_guardian_user(text, text, text, uuid, text); Type: FUNCTION; Schema: public; Owner: postgres
--
...
--
-- Name: create_staff_user(text, text, text, text); Type: FUNCTION; Schema: public; Owner: postgres
--
...
--
-- Name: is_my_student(uuid); Type: FUNCTION; Schema: public; Owner: postgres
--
...
--
-- Name: is_staff_of_student(uuid); Type: FUNCTION; Schema: public; Owner: postgres
--
...
CREATE TABLE IF NOT EXISTS public.audit_logs (
    ...
    CONSTRAINT audit_logs_severity_check CHECK ((severity = ANY (ARRAY['INFO'::text, 'WARN'::text, 'ERROR'::text])))
);
...
--
-- Name: COLUMN audit_logs.severity; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: classroom_daily_notes; Type: TABLE; Schema: public; Owner: postgres
--
...
CREATE TABLE IF NOT EXISTS public.daily_logs (
    ...
    CONSTRAINT daily_logs_status_check CHECK ((status = ANY (ARRAY['draft'::text, 'published'::text])))
);
...
--
-- Name: dining_menus; Type: TABLE; Schema: public; Owner: postgres
--
...
--
-- Name: events_announcements; Type: TABLE; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE push_subscriptions; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: school_billing_events; Type: TABLE; Schema: public; Owner: postgres
--
...
--
-- Name: school_documents; Type: TABLE; Schema: public; Owner: postgres
--
...
--
-- Name: classroom_daily_notes classroom_daily_notes_classroom_id_date_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: classroom_daily_notes classroom_daily_notes_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: classrooms classrooms_school_id_name_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: daily_logs daily_logs_student_id_date_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: dining_menus dining_menus_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: dining_menus dining_menus_school_id_month_year_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: events_announcements events_announcements_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: school_billing_events school_billing_events_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: school_documents school_documents_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: staff_attendance staff_attendance_staff_id_date_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: audit_logs_action_created_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX IF NOT EXISTS audit_logs_action_created_idx ON public.audit_logs USING btree (action, created_at DESC);
...
CREATE INDEX IF NOT EXISTS audit_logs_actor_id_idx ON public.audit_logs USING btree (actor_id);
...
--
-- Name: audit_logs_school_id_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX IF NOT EXISTS audit_logs_school_id_idx ON public.audit_logs USING btree (school_id);


--
-- Name: audit_logs_severity_created_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX IF NOT EXISTS audit_logs_severity_created_idx ON public.audit_logs USING btree (severity, created_at DESC);


--
-- Name: idx_classrooms_school; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX IF NOT EXISTS idx_classrooms_school ON public.classrooms USING btree (school_id);
...
CREATE INDEX IF NOT EXISTS idx_classrooms_teacher ON public.classrooms USING btree (teacher_id);


--
-- Name: idx_daily_logs_classroom_date; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX IF NOT EXISTS idx_daily_logs_classroom_date ON public.daily_logs USING btree (classroom_id, date DESC);


--
-- Name: idx_daily_logs_classroom_date_status; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX IF NOT EXISTS idx_daily_logs_classroom_date_status ON public.daily_logs USING btree (classroom_id, date, status);


--
-- Name: idx_daily_logs_date; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX IF NOT EXISTS idx_daily_logs_date ON public.daily_logs USING btree (date DESC);


--
-- Name: idx_daily_logs_school; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX IF NOT EXISTS idx_daily_logs_school ON public.daily_logs USING btree (school_id);
...
CREATE INDEX IF NOT EXISTS idx_daily_logs_student_date ON public.daily_logs USING btree (student_id, date DESC);


--
-- Name: idx_dining_menus_school; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX IF NOT EXISTS idx_dining_menus_school ON public.dining_menus USING btree (school_id);


--
-- Name: idx_events_classroom; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX IF NOT EXISTS idx_events_classroom ON public.events_announcements USING btree (classroom_id);
...
CREATE INDEX IF NOT EXISTS idx_events_date ON public.events_announcements USING btree (event_date DESC);


--
-- Name: idx_events_school; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX IF NOT EXISTS idx_events_school ON public.events_announcements USING btree (school_id);
...
--
-- Name: idx_messages_school; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX IF NOT EXISTS idx_messages_school ON public.messages USING btree (school_id);
...
--
-- Name: idx_messages_student; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX IF NOT EXISTS idx_messages_student ON public.messages USING btree (student_id);
...
CREATE INDEX IF NOT EXISTS idx_profiles_role ON public.profiles USING btree (school_id, role);


--
-- Name: idx_profiles_school; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX IF NOT EXISTS idx_profiles_school ON public.profiles USING btree (school_id);


--
-- Name: idx_schools_slug; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX IF NOT EXISTS idx_schools_slug ON public.schools USING btree (slug);


--
-- Name: idx_staff_attendance_date; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX IF NOT EXISTS idx_staff_attendance_date ON public.staff_attendance USING btree (date DESC);


--
-- Name: idx_staff_attendance_school; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX IF NOT EXISTS idx_staff_attendance_school ON public.staff_attendance USING btree (school_id);


--
-- Name: idx_student_guardians_guardian; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX IF NOT EXISTS idx_student_guardians_guardian ON public.student_guardians USING btree (guardian_id);


--
-- Name: idx_student_guardians_student; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX IF NOT EXISTS idx_student_guardians_student ON public.student_guardians USING btree (student_id);


--
-- Name: idx_students_classroom; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX IF NOT EXISTS idx_students_classroom ON public.students USING btree (classroom_id);
...
--
-- Name: school_billing_events_school_id_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX IF NOT EXISTS school_billing_events_school_id_idx ON public.school_billing_events USING btree (school_id);


--
-- Name: school_documents_school_id_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX IF NOT EXISTS school_documents_school_id_idx ON public.school_documents USING btree (school_id);


--
-- Name: school_invoices_due_date_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX IF NOT EXISTS school_invoices_due_date_idx ON public.school_invoices USING btree (due_date);


--
-- Name: school_invoices_school_id_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX IF NOT EXISTS school_invoices_school_id_idx ON public.school_invoices USING btree (school_id);


--
-- Name: school_invoices_status_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX IF NOT EXISTS school_invoices_status_idx ON public.school_invoices USING btree (status);


--
-- Name: daily_logs set_daily_logs_updated_at; Type: TRIGGER; Schema: public; Owner: postgres
--

DROP TRIGGER IF EXISTS set_daily_logs_updated_at ON public.daily_logs;
CREATE TRIGGER set_daily_logs_updated_at BEFORE UPDATE ON public.daily_logs FOR EACH ROW EXECUTE FUNCTION public.update_updated_at();


--
-- Name: staff_attendance set_staff_attendance_updated_at; Type: TRIGGER; Schema: public; Owner: postgres
--

DROP TRIGGER IF EXISTS set_staff_attendance_updated_at ON public.staff_attendance;
CREATE TRIGGER set_staff_attendance_updated_at BEFORE UPDATE ON public.staff_attendance FOR EACH ROW EXECUTE FUNCTION public.update_updated_at();
...
--
-- Name: classroom_daily_notes classroom_daily_notes_classroom_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: classroom_daily_notes classroom_daily_notes_school_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: classroom_daily_notes classroom_daily_notes_teacher_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: classrooms classrooms_school_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: daily_logs daily_logs_classroom_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: daily_logs daily_logs_school_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: daily_logs daily_logs_teacher_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: dining_menus dining_menus_school_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: events_announcements events_announcements_author_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: events_announcements events_announcements_classroom_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: events_announcements events_announcements_school_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: messages messages_school_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: school_billing_events school_billing_events_actor_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: school_billing_events school_billing_events_school_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: school_documents school_documents_school_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: school_documents school_documents_uploaded_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: school_invoices school_invoices_created_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: school_invoices school_invoices_school_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: staff_attendance staff_attendance_school_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: students students_classroom_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: audit_logs audit_logs_service_only; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: classroom_daily_notes; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE public.classroom_daily_notes ENABLE ROW LEVEL SECURITY;

--
-- Name: classroom_daily_notes classroom_daily_notes_select_guardian; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: classroom_daily_notes classroom_daily_notes_select_staff; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: classrooms classrooms_modify_admin; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: classrooms classrooms_select_school; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: daily_logs daily_logs_delete_admin; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: daily_logs daily_logs_insert_teacher; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: daily_logs daily_logs_select_guardian; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: daily_logs daily_logs_select_staff; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: daily_logs daily_logs_update_teacher; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: dining_menus; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE public.dining_menus ENABLE ROW LEVEL SECURITY;

--
-- Name: dining_menus dining_menus_modify_admin; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: dining_menus dining_menus_select_school; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: events_announcements; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE public.events_announcements ENABLE ROW LEVEL SECURITY;

--
-- Name: events_announcements events_modify_staff; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: events_announcements events_select_school; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: messages messages_update; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: profiles profiles_insert_admin; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: profiles profiles_select_guardian; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: profiles profiles_select_teacher; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: push_subscriptions push_subscriptions_delete_own; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: push_subscriptions push_subscriptions_insert_own; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: push_subscriptions push_subscriptions_select_own; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: push_subscriptions push_subscriptions_service_all; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY push_subscriptions_service_all ON public.push_subscriptions TO service_role USING (true) WITH CHECK (true);


--
-- Name: push_subscriptions push_subscriptions_update_own; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: school_billing_events; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE public.school_billing_events ENABLE ROW LEVEL SECURITY;

--
-- Name: school_billing_events school_billing_events_service; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: school_documents; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE public.school_documents ENABLE ROW LEVEL SECURITY;

--
-- Name: school_documents school_documents_service; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: school_invoices; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE public.school_invoices ENABLE ROW LEVEL SECURITY;

--
-- Name: school_invoices school_invoices_service; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: schools school_select_own; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: schools school_update_admin; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: schools schools_select_member; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: staff_attendance; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE public.staff_attendance ENABLE ROW LEVEL SECURITY;

--
-- Name: staff_attendance staff_attendance_admin_all; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: staff_attendance staff_attendance_staff_select; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: student_guardians student_guardians_modify_admin; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: student_guardians student_guardians_select_guardian; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: student_guardians student_guardians_select_own; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: student_guardians student_guardians_select_staff; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: students students_modify_admin; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: students students_select_guardian; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: students students_select_staff; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: schools superadmin_read_schools; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION admin_set_user_password(p_user_id uuid, p_password text); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION create_guardian_user(p_email text, p_full_name text, p_phone text, p_school_id uuid, p_password text); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION create_staff_user(p_email text, p_full_name text, p_role text, p_password text); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION is_my_student(p_student_id uuid); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION is_staff_of_student(p_student_id uuid); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE classroom_daily_notes; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE dining_menus; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE events_announcements; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE school_billing_events; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE school_documents; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE staff_attendance; Type: ACL; Schema: public; Owner: postgres
--
